(function (root, factory) {
    ...
    function toggle(event) {
        ...
        if (event) {
            ...
            _options.hideCallback.call(_colorPicker, $(_colorPicker.$trigger));
    ...
    function build(newtriger) {
        ...
        return $(_html).css({'margin': _options.margin})
            ...
            .show(0, function() {
                ...
                _options.buildCallback.call(_colorPicker, _$UI,newtriger);
